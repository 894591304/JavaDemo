...
@Component
@Scope("prototype")
public class TicketGiveDetailTag extends BaseFreeMarkerTag{
	...
	protected Object exec(Map arg0) throws TemplateModelException {
		...
		if(member == null){
			throw new TemplateModelException("未登录不能使用此标签[TicketGiveDetailTag]");
		}
		...
		try
		{
			...
			int proxyorderid = ticketGive.getProxyorderId();
			...
			result.put("code",ticketGive.getGiveKey());
		}catch (Exception e)
		{
