        ...
        return this.each(function() {
            ...
            this.createHtml = function() {
                ...
                if (para.dragDrop) {
                    ...
                    html += '					<div class="upload_btn" id="upbtn" style="display:none">开始上传</div>';
                    html += "				</div>";
                    html += "			</div>";
                    ...
                    //html += '				<div class="btns">';
                    html += '					<input id="fileImage" type="file" size="30" name="fileselect[]" ' + multiple + ">";
                    //html += '					<div class="webuploader_pick" id="selfile">选择文件</div>';
                    html += '					<div class="upload_btn" id="upbtn" style="display:none">开始上传</div>';
                    //html += "				</div>";
                    //html += "			</div>";
                    html += '			<div id="preview" class="upload_preview" style="display:none;">';
