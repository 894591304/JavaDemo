...
<table class="form-table">
	<tr>
		...
		<td><input type="hidden" name="goods.goods_type" value="bind"/><input type="text" name="goods.name" id="goods_name"
			class="input_text" dataType="string" isrequired="true"
			 /></td>
	</tr>
	<tr>
		<th>货号：</th>
		<td><input type="text" name="goods.sn" class="input_text" dataType="string" isrequired="true"
			 /></td>
	</tr>
	<tr>
		<th>是否上架销售：</th>
	...
	<tr>
		<th>第三方平台：</th>
		<td><input type="text" name="goods.thirdPlatform" id="thirdPlatform"
			class="input_text" dataType="float"/>
		</td>
	</tr>
