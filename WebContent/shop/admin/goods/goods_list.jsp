...
<script type="text/javascript" src="js/GoodsStore.js"></script>
	...
	<form id="gridform">
		<grid:grid from="webpage">
			...
			<grid:body item="goods">
				<c:if test="${optype==null || optype=='' }">
				<td>
					<input type="checkbox" name="id" value="${goods.goods_id }" />${goods.goods_id }
				</td>
				</c:if>
        ...
        <c:if test="${optype==null || optype=='' }">
				...
				<grid:cell>
					...
					<c:if test="${optype=='stock' ||  optype=='alarm'}">
						 <a href="javascript:;"><img goodsid="${ goods.goods_id }"
...
$(function(){
	$(".gridbody thead a,.gridbody .page a,#searchcbox .submitBtn" ).click(function(){
		$.Loading.show("请稍候..");
	});
	$.ajax({
