...
<link type="text/css" rel="stylesheet" href="../../adminthemes/default/css/style.css">
<link type="text/css" rel="stylesheet" href="../../adminthemes/default/css/global.css">
<link type="text/css" rel="stylesheet" href="../../adminthemes/default/css/grid.css">
<link type="text/css" rel="stylesheet" href="../../adminthemes/default/css/input.css">
<link type="text/css" rel="stylesheet" href="../../adminthemes/default/css/validate.css">
<link type="text/css" rel="stylesheet" href="../../adminthemes/default/css/dialog.css">
...
<table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	<tbody>
		<tr>
			<th>配送方式名称:</th>
			<td><input type="text" maxlength="20"   name="type.name" value="${type.name }"  dataType="string" isrequired="true"></td>
			<th>选择默认物流公司:</th>
				...
				<li style="line-height: 30px;display:none" class="division">
					...
					<div class="deliverycity" >
	                     <span class="delCfgBtn" style="float: right;"><img border="none" title="删除" alt="删除" style="width: 16px; height: 16px; background-image: url('images/ImageBundle.gif'); background-repeat: no-repeat; background-position: 0pt -91px; cursor: pointer;" src="images/transparent.gif"></span>
	                  	 配送地区 <input type="text"  disabled="true"  readonly="true" name="areaGroupName" style="width: 300px;" dataType="string" isrequired="true">
			...
			<c:forEach var="typeArea"  items="${type.typeAreaList}" varStatus="area">
				<li style="line-height: 30px;" class="division" id="deliverycity_${area.index}">
					...
					<div class="deliverycity" >
	                     <span class="delCfgBtn" style="float: right;"><img border="none" title="删除" alt="删除" style="width: 16px; height: 16px; background-image: url('images/ImageBundle.gif'); background-repeat: no-repeat; background-position: 0pt -91px; cursor: pointer;" src="images/transparent.gif"></span>
	                  	 配送地区
	                  	  <input type="text" readonly="true" name="areaGroupName" style="width: 300px;" value="${typeArea.area_name_group}"  dataType="string" isrequired="true"/>
...
<div class="division">
        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table">
            <tbody><tr>
                <th>排序:</th>
                <td>
                    <input type="text"  size="5" id="ordernum" name="type.ordernum" value="${type.ordernum}"  dataType="int" isrequired="true">
                </td>
            </tr>
            <tr>
                <th>状态:</th>
