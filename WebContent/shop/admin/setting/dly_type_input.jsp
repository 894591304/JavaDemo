...
<script type="text/javascript" src="../../adminthemes/new/js/common.js"></script>
...
<link type="text/css" rel="stylesheet" href="../../adminthemes/new/css/main.css">
			...
			<div class="division">
				<table cellspacing="1" cellpadding="3" width="100%"
					...
					<tbody>
						<tr>
							<th>配送方式名称:</th>
							<td><input type="text" maxlength="20" name="type.name"
								value="${type.name }" dataType="string" isrequired="true"
								class="input_text"></td>
							<th>选择默认物流公司:</th>
						...
						<tr>
							<th>&nbsp;</th>
							<td><input type="checkbox" value="1" id="protect"
								name="type.protect">支持物流保价</td>
							<th>&nbsp;</th>
							<td>&nbsp;</td>
						</tr>
						<tr id="protectrate" style="display: none">
							<th>保价设置:</th>
							<td>费率&nbsp;<input type="text" id="protect_rate"
								name="type.protect_rate" style="width: 25px" dataType="float" />
								% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								最低保价费&nbsp;<input type="text" style="width: 25px;"
								id="min_price" name="type.min_price" dataType="float"></td>
							<th>&nbsp;</th>
							<td>&nbsp;</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<div class="deliveryexpbox" style="line-height: 30px;">
									...
									<label><input type="hidden" name="has_cod" value="0" /><input
										type="checkbox" value="1" name="have_cod_check">支持货到付款</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
							</td>
						</tr>
					</tbody>
							...
							<td>
								<div class="deliveryArea">
									<ol style="list-style: decimal outside none;">
										...
										<li style="line-height: 30px; display: none" class="division">
											...
											<div class="deliverycity">
												<span class="delCfgBtn" style="float: right;"><img
													...
													src="images/transparent.gif"></span> 配送地区 <input type="text"
													disabled="true" readonly="true" name="areaGroupName"
													style="width: 300px;" dataType="string" isrequired="true">
												<input type="hidden" disabled="true" name="areaGroupId"><img
													border="none" class="editAreaImg" title="编辑地区" alt="编辑地区"
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label><input
													type="hidden" disabled="true" name="has_cod" value="0" /><input
													type="checkbox" disabled="true" value="1"
										...
										<c:forEach var="typeArea" items="${type.typeAreaList}"
											varStatus="area">
											<li style="line-height: 30px;" class="division"
												id="deliverycity_${area.index}">

												<div class="deliverycity">
													<span class="delCfgBtn" style="float: right;"><img
														border="none" title="删除" alt="删除"
														style="width: 16px; height: 16px; background-image: url('images/ImageBundle.gif'); background-repeat: no-repeat; background-position: 0pt -91px; cursor: pointer;"
														src="images/transparent.gif"></span> 配送地区 <input
														type="text" readonly="true" name="areaGroupName"
														style="width: 300px;" value="${typeArea.area_name_group}"
														dataType="string" isrequired="true" /> <input
														type="hidden" name="areaGroupId"
														value="${typeArea.area_id_group }" /><img border="none"
														class="editAreaImg" title="编辑地区" alt="编辑地区"
														style="width: 16px; height: 16px; background-image: url('images/ImageBundle.gif'); background-repeat: no-repeat; background-position: 0pt -139px; cursor: pointer;"
														src="images/transparent.gif" class="regionSelect">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label><input
														type="hidden" name="has_cod" value="0" /><input
														type="checkbox" value="1" name="have_cod_check">支持货到付款</label>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												</div>
								...
								</div> <input type="button" id="addCfgBtn" class="sysbtn"
								value="为指定的地区设置运费" />
								</div>
							</td>
						</tr>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" size="5" id="ordernum"
								name="type.ordernum" value="${type.ordernum}" dataType="int"
			...
			<table>
				<tr>
					<td><input name="submit" type="submit" value=" 确    定   "
						class="submitBtn button blueButton" /></td>
				</tr>
			</table>
		</div>
		</form>
...
<style>
.form-table td,.submitlist{background:#f1f1f1;}
.division{margin:0px;padding:0px;}
</style>